...
const stopAmimation_1 = __webpack_require__(/*! ./stopAmimation */ "./src/assets/components/animation/stopAmimation.ts");
// import swopWins from '../winner/swopWins';
async function setAmimation(carItem) {
    ...
    requestAnimationFrame(async function animate() {
        ...
        if (!status) {
            await (0, stopAmimation_1.default)(carItem);
            return true;
        }
        ;
...
/***/ "./src/assets/components/animation/stopALLAmimations.ts":
/*!**************************************************************!*\
  !*** ./src/assets/components/animation/stopALLAmimations.ts ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const setLeft_1 = __webpack_require__(/*! ./setLeft */ "./src/assets/components/animation/setLeft.ts");
const stopAmimation_1 = __webpack_require__(/*! ./stopAmimation */ "./src/assets/components/animation/stopAmimation.ts");
async function stopALLAmimations() {
    const itemCars = document.querySelectorAll('.item-car');
    itemCars.forEach(element => {
        (0, stopAmimation_1.default)(element);
        (0, setLeft_1.default)(element);
    });
}
exports["default"] = stopALLAmimations;
...
/***/ "./src/assets/components/createCars/createCars.ts":
/*!********************************************************!*\
  !*** ./src/assets/components/createCars/createCars.ts ***!
  \********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const carsName_1 = __webpack_require__(/*! ../date/carsName */ "./src/assets/components/date/carsName.ts");
...
const setNumberPage_1 = __webpack_require__(/*! ../pagination/setNumberPage */ "./src/assets/components/pagination/setNumberPage.ts");
async function createCars() {
    for (let i = 0; i < 100;) {
        const firsName = carsName_1.default[0];
        const secandName = carsName_1.default[1];
        const min = 0;
        const max = 9;
        const firs = Math.floor(Math.random() * (max - min + 1) + min);
        const secand = Math.floor(Math.random() * (max - min + 1) + min);
        const color = getRandomColor();
        const date = {
            "name": `${firsName[firs]} ${secandName[secand]}`,
            "color": color,
        };
        if (document.querySelectorAll('.item-car').length < 7) {
            await interactionGarage_1.default.createCar(date).then((e) => {
                (0, createGameHtml_1.default)(`${firsName[firs]} ${secandName[secand]}`, color, e.id);
            });
        }
        else {
...
/***/ "./src/assets/components/date/carsName.ts":
/*!************************************************!*\
  !*** ./src/assets/components/date/carsName.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const carsName = [
    ['Audi', 'Chevrolet', 'Bentley', 'BMW', 'Ferrari', 'Nissan', 'Jaguar', 'Saab', 'Mini', 'Tesla', 'Toyota'],
    ['RS2', 'Super 90', 'Flying Spur', 'GTZ', 'Celica', 'Aristo', 'F430', 'F8', 'California', 'Mondial']
];
exports["default"] = carsName;
...
buttonGenerate.textContent = 'Gererate';
...
async function createTable() {
    ...
    let order;
    const sorterActive = document.querySelector('.sorter-activ');
    if (sorterActive === null || sorterActive === void 0 ? void 0 : sorterActive.classList.contains('sorter-up')) {
        order = 'ASC';
    }
    if (sorterActive === null || sorterActive === void 0 ? void 0 : sorterActive.classList.contains('sorter-down')) {
        order = 'DESC';
    }
    let link;
    const page = '1';
    const limit = '7';
    // const sort = `${sorterActive!.parentElement?.parentElement?.id}`;
    if (sorterActive) {
        link = `?_page=${page}&_limit=${limit}&_sort=${(_b = (_a = sorterActive.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement) === null || _b === void 0 ? void 0 : _b.id}&_order=${order}`;
    }
    else {
        link = `?_limit=${limit}`;
    }
    const winners = await interactionWinners_1.default.getWinners(link);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const swopArrow_1 = __webpack_require__(/*! ./swopArrow */ "./src/assets/components/winner/swopArrow.ts");
...
trHeader.addEventListener('click', swopArrow_1.default);
// th open
...
function createArrows(th) {
    let arrow = document.createElement('span');
    arrow.innerHTML = `
    <svg class="anticon sorter-up" viewBox="0 0 1024 1024" focusable="false" data-icon="caret-up" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M858.9 689L530.5 308.2c-9.4-10.9-27.5-10.9-37 0L165.1 689c-12.2 14.2-1.2 35 18.5 35h656.8c19.7 0 30.7-20.8 18.5-35z"></path></svg></span>
    <svg class="anticon sorter-down" viewBox="0 0 1024 1024" focusable="false" data-icon="caret-down" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M840.4 300H183.6c-19.7 0-30.7 20.8-18.5 35l328.4 380.8c9.4 10.9 27.5 10.9 37 0L858.9 335c12.2-14.2 1.2-35-18.5-35z"></path></svg></span>
   `;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const interactionWinners_1 = __webpack_require__(/*! ../interactionWinners */ "./src/assets/components/interactionWinners.ts");
const swopWins_1 = __webpack_require__(/*! ./swopWins */ "./src/assets/components/winner/swopWins.ts");
async function saveWinners(carItem, start) {
    ...
    arrayWinners.forEach(async (element) => {
        console.log(element.id == +carItem.id);
        if (element.id == +carItem.id) {
            const winner = await interactionWinners_1.default.getWinner(carItem.id);
            updateWin(winner, carItem);
        }
        return;
    });
    createWin(date);
...
async function createWin(date) {
    const gameActive = document.querySelector('.section__game');
    if ((gameActive === null || gameActive === void 0 ? void 0 : gameActive.className) == 'section__game game-active') {
        return;
    }
    ;
    console.log(1);
    console.log((gameActive === null || gameActive === void 0 ? void 0 : gameActive.className) == 'section__game game-active');
    await interactionWinners_1.default.createWinner(date);
}
async function updateWin(date, carItem) {
    const gameActive = document.querySelector('.section__game');
    if ((gameActive === null || gameActive === void 0 ? void 0 : gameActive.className) == 'section__game game-active') {
        return;
    }
    ...
    console.log(2);
    (0, swopWins_1.default)(date.time, date.id);
...
/***/ "./src/assets/components/winner/swopArrow.ts":
/*!***************************************************!*\
  !*** ./src/assets/components/winner/swopArrow.ts ***!
  \***************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const createTable_1 = __webpack_require__(/*! ./createTable */ "./src/assets/components/winner/createTable.ts");
function swopArrow(e) {
    if (!(e.target instanceof SVGElement)) {
        return;
    }
    ;
    const sorterActiv = document.querySelector('.sorter-activ');
    if (sorterActiv) {
        sorterActiv.classList.remove('sorter-activ');
    }
    ;
    e.target.classList.add('sorter-activ');
    (0, createTable_1.default)();
}
exports["default"] = swopArrow;


/***/ }),

/***/ "./src/assets/components/winner/swopWins.ts":
/*!**************************************************!*\
  !*** ./src/assets/components/winner/swopWins.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const interactionGarage_1 = __webpack_require__(/*! ../interactionGarage */ "./src/assets/components/interactionGarage.ts");
async function swopWins(time, id) {
    const body = document.querySelector('.wrapper');
    const name = await interactionGarage_1.default.getCar(id);
...
const stopALLAmimations_1 = __webpack_require__(/*! ./assets/components/animation/stopALLAmimations */ "./src/assets/components/animation/stopALLAmimations.ts");
const createCars_1 = __webpack_require__(/*! ./assets/components/createCars/createCars */ "./src/assets/components/createCars/createCars.ts");
...
/******/ })()
;
//# sourceMappingURL=main.aa93a79dee6fb42f1639.js.map