...
async function setAmimation(carItem) {
    ...
    requestAnimationFrame(function animate() {
        step = step + velocity;
        draw(step, img);
        let status = getStatus(step, wigthLine, carItem);
        if (!status) {
            return;
        }
...
function getStatus(step, wigthLine, carItem) {
...
function createListenerCar(carItem, id) {
    carItem.addEventListener('click', (e) => {
        ...
        if (['button button__remuve'].includes((_c = e.target) === null || _c === void 0 ? void 0 : _c.className)) {
            interactionGarage_1.default.deleteCar(id);
...
/******/ })()
;
//# sourceMappingURL=main.f409a1704a6cc3869bbd.js.map